...
class BootStrap {
    ...
    def init = { servletContext -> registerMarshallers()
        ...
        def defaultMenu = new Menu(name : "Home" ,orderBy : "0", module: "13").save()
        def defaultMenu1 = new Menu(name : "Home" ,orderBy : "0", module: "2").save()
        def defaultMenu2 = new Menu(name : "Home" ,orderBy : "0", module: "4").save()
        def defaultMenu3 = new Menu(name : "Home" ,orderBy : "0", module: "9").save()
        def defaultMenu4 = new Menu(name : "Home" ,orderBy : "0", module: "12").save()
