    ...
    <div>
        <ul class="nav nav-tabs">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>${menu.name}</li>
                    <g:each in="${menu}" var="menu" status="i">
                        <li>${menu.name}</li>
                    </g:each>
               </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><g:link class="home" controller="invoice" action="invoice" >Create invoice</g:link></li>
                    <li><g:link class="home" >Invoices</g:link></li>
                </ul>
            </li>
        </ul><br>
    </div>
